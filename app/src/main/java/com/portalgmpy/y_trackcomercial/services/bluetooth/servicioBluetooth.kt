package com.portalgmpy.y_trackcomercial.services.bluetooth
...
class servicioBluetooth(private val context: Context) {
    fun imprimir(texto: String): ImpresionResultado {
        try {
            ...
            val img2= "[C]Kude generado por\n"
            val img3= "[C]<img>" + PrinterTextParserImg.bitmapToHexadecimalString(printer,   context.getResources().getDrawableForDensity(R.drawable.logo_impre_ytrack, DisplayMetrics.DENSITY_XHIGH))+"</img>\n"
            val texto=img+texto+img2+img3
