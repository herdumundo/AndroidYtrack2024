...
suspend fun insertRoomLocation(
    ...
    if (currentTimeString >= "06:00" && currentTimeString <= "20:00"  && sharedData.porcentajeBateriaAnterior.value!=porceBateria ) {
        CoroutineScope(Dispatchers.Main).launch {
            sharedData.porcentajeBateriaAnterior.postValue(porceBateria)
        }
