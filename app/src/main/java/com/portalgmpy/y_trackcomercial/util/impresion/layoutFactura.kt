package com.portalgmpy.y_trackcomercial.util.impresion
       ...
       // val oinvList: List<OinvPosWithDetails> = gson.fromJson(json, listType)
        ...
        json.forEach { oinvDetails ->
            ...
            for (detail in details) {
                ...
                //ESPACIO ENTRE cantidadFormateada Y formattedprice
                val sp      ="        "
                val sp1     ="      "
                //ESPACIO ENTRE taxCode Y cantidadFormateada
                val espCab1 ="        " //
                val espCab2 ="      " //
                val esCab3  ="     "
                val esCab4  ="      "
                ...
                val spaCanPri = when (detail.quantity.length) {
                    4 -> sp1
                    else -> sp
                }

                factura +="[L]<b>${detail.CodeBars}-${detail.itemCode}-${detail.itemName}</b>        \n" +
                        "[L]<b>${detail.taxCode}%</b>$espaciosCab<b>${cantidadFormateada}</b>${spaCanPri}<b>${formattedprice}</b>  [R]<b>$formattedTotalPrice</b>\n"
            ...
            factura +="[C]================================================\n\n" +
                    ...
                    "[C]escriba a vimar.fe@yemita.com\n" +
