...
import com.portalgmpy.y_trackcomercial.data.api.response.OCRD
...
import com.portalgmpy.y_trackcomercial.repository.RutasAccesosRepository
import com.portalgmpy.y_trackcomercial.usecases.login.AuthUseCase
...
class MenuPrincipalViewModel @Inject constructor(
    ...
    val customers: LiveData<List<com.portalgmpy.y_trackcomercial.data.model.entities.OCRDEntity>> =
