package com.portalgmpy.y_trackcomercial.ui.repartoLibre.viewmodel
...
class RepartoLibreViewModel @Inject constructor(
    ...
    val productos: MutableLiveData<List<ProductoItem>?> = _productos
    ...
    val docNum: MutableLiveData<Int?> = _docNum
    ...
    var pymntGroup: MutableLiveData<String?> = _pymntGroup
    ...
    fun registrar(productos: List<ProductosSeleccionados>) {
        ...
        viewModelScope.launch {
            ...
            val datosAzure = getUltimoNroFacturaAzureUseCase.Obtener(_datosCliente.value!![0].cardCode2!!)
            val nroFactura =  datosAzure.ult_nro_fact//LA SUMA DEL NRO SIGUIENTE SE HACE DENTRO DE LA FUNCION OBTENER.
