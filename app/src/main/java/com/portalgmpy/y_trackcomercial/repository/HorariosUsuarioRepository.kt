...
import com.portalgmpy.y_trackcomercial.util.HoraActualUtils.convertirStringToLocalTime
import com.portalgmpy.y_trackcomercial.util.SharedPreferences
import com.portalgmpy.y_trackcomercial.util.ValidacionesVisitas.ValidacionInicioHoraResult
...
class HorariosUsuarioRepository @Inject constructor(
    ...
    private val horariosUsuarioDao: com.portalgmpy.y_trackcomercial.data.model.dao.HorariosUsuarioDao
) {
    ...
    private fun convertToEntityList(horariosResponseList: List<com.portalgmpy.y_trackcomercial.data.model.models.HorariosUsuarioResponse>): List<com.portalgmpy.y_trackcomercial.data.model.entities.HorariosUsuarioEntity> {
        val entityList = mutableListOf<com.portalgmpy.y_trackcomercial.data.model.entities.HorariosUsuarioEntity>()
        for (horarioResponse in horariosResponseList) {
            for (yemsysHorario in horarioResponse.yemsys_horarios) {
                for (yemsysTurno in yemsysHorario.yemsys_turnos) {
                    val entity =
                        com.portalgmpy.y_trackcomercial.data.model.entities.HorariosUsuarioEntity(
                            id = yemsysTurno.id,
