package com.portalgmpy.y_trackcomercial.data.model.dao.registroDaos
...
interface MovimientosDao {
    @Transaction
    @Insert
    suspend fun insertAllMovimiento(Movimiento: List<com.portalgmpy.y_trackcomercial.data.model.entities.registro_entities.MovimientosEntity>)
    ...
    suspend fun getInformeMovimiento(fecha: String): MutableList<com.portalgmpy.y_trackcomercial.data.model.models.InformeInventario>
