package com.portalgmpy.y_trackcomercial.data.model.dao.registroDaos.logsDaos
...
interface AuditTrailDao {
    ...
    @Query("DELETE FROM audittrail  WHERE  fechaLong IN (:ids)")
    suspend fun eliminarRegistrosPorLotes(ids: List<String>)
}