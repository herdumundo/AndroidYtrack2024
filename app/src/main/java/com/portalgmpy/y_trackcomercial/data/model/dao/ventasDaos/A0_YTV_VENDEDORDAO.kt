...
import com.portalgmpy.y_trackcomercial.data.api.request.balanceOcrd
...
interface A0_YTV_VENDEDORDAO {
    ...
    @Query("select distinct Balance,CreditDisp,CreditLine  from ocrd WHERE cardCode2=:cardCode")
