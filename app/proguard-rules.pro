...
-keep class com.portalgmpy.y_trackcomercial.MainActivity
# Aplicar ofuscación a todas las clases en el paquete com.ytrack.y_trackcomercial excepto MainActivity
-keep class com.portalgmpy.y_trackcomercial.** { *; }
-keep class com.portalgmpy.y_trackcomercial.core.** { *; }
-keep class com.portalgmpy.y_trackcomercial.data.** { *; }
-keep class com.portalgmpy.y_trackcomercial.repository.** { *; }
-keep class com.portalgmpy.y_trackcomercial.services.** { *; }
-keep class com.portalgmpy.y_trackcomercial.components.** { *; }
-keep class com.portalgmpy.y_trackcomercial.ui.** { *; }
-keep class com.portalgmpy.y_trackcomercial.usecases.** { *; }
-keep class com.portalgmpy.y_trackcomercial.util.** { *; }
